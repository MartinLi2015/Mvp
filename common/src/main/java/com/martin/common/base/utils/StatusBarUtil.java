...
import com.martin.common.view.statusbar.StatusBarView;

/**
 * Created by martin on 2017/5/3.
 */
...
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, @ColorInt int color, int statusBarAlpha) {
        ...
        } else if (ApiUtil.isSupportApi(Build.VERSION_CODES.KITKAT)) {
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
    ...
    public static void setColorForSwipeBack(Activity activity, int color, int statusBarAlpha) {
        if (ApiUtil.isSupportApi(Build.VERSION_CODES.KITKAT)) {
...
///////////////////////////////////////////////////////////////////////////////////
    ...
    private static int calculateStatusColor(@ColorInt int color, int aplha) {
        float a = 1 - aplha / 255f;
